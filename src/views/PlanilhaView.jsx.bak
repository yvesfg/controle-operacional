 ...
 *                planilhaPagina, setPlanilhaPagina, planilhaDetalheReg, setPlanilhaDetalheReg,
...
export default function PlanilhaView({ ctx }) {
  ...
  const temFiltro = planilhaFiltroAno || planilhaFiltroMes || planilhaFiltroOrigem !== "todas";
              ...
              {COLS.map(c => {
                ...
                return (
                  <th key={c.k}
                    ...
                    style={{
                      padding: "9px 6px", textAlign: "left",
          ...
          <tbody>
            {dadosExibir.map((r, i) => (
              <tr key={i}
                ...
                onClick={() => setPlanilhaDetalheReg(r)}
              ...
              >
                ...
                <td style={{
                  padding: "7px 6px", borderBottom: "1px solid var(--border)",
                  color: "var(--yellow, #eab308)", fontSize: 10,
