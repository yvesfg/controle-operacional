    ...
    >
      ...
      <div style={{display:"flex",alignItems:"flex-start",justifyContent:"space-between",gap:8,flexWrap:"wrap"}}>
        <div style={{minWidth:0,flex:1}}>
          <div style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:700,fontSize:13,color:"var(--text)",letterSpacing:"-0.01em",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>
            {r.nome || "—"}
          </div>
          <div style={{fontSize:10,color:"var(--text3)",fontFamily:"'DM Mono',monospace",letterSpacing:"0.04em",marginTop:2,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>
            DT {r.dt}
        ...
        <div style={{
          ...
          {hasChegada && (
            <div style={{background:"var(--card2)",borderRadius:7,border:"1px solid var(--border)",padding:"6px 8px"}}>
              <div style={{fontSize:8,fontFamily:"'DM Mono',monospace",letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--cyan,#06b6d4)",marginBottom:3,fontWeight:500}}>Obs Chegada</div>
          ...
          {hasDescarga && (
            <div style={{background:"var(--card2)",borderRadius:7,border:"1px solid var(--border)",padding:"6px 8px"}}>
              <div style={{fontSize:8,fontFamily:"'DM Mono',monospace",letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--green,#22c55e)",marginBottom:3,fontWeight:500}}>Obs Descarga</div>
              <div style={{fontSize:10,color:"var(--text2)",lineHeight:1.35}}>
  ...
  return (
    <div style={{padding:isMobile?"12px":"16px 24px",width:"100%",boxSizing:"border-box"}}>
      ...
      <div className="co-filter-bar">
        ...
        <span style={{fontSize:9,fontFamily:"'DM Mono',monospace",letterSpacing:"0.08em",textTransform:"uppercase",color:"var(--text3)",marginLeft:4}}>Data:</span>
