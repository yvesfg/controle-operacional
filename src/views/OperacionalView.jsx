                      ...
                      <div style={{ display: "flex", alignItems: "flex-start", gap: 8 }}>
                        <div style={{ flex: 1 }}>
                          <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
                            <span style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: 13, fontWeight: 700, letterSpacing: "-0.01em", color: "var(--yellow, #eab308)" }}>{s.numero || "—"}</span>
                            <span style={{ fontSize: 9, fontWeight: 700, color: statusC, background: `${statusC}18`, border: `1px solid ${statusC}33`, borderRadius: 4, padding: "2px 7px", fontFamily: "'DM Mono', monospace", letterSpacing: "0.04em" }}>{statusIco} {s.status?.toUpperCase() || "ABERTO"}</span>
            ...
            return (
              <div style={{ background: `rgba(124,58,237,.04)`, border: `1px solid rgba(124,58,237,.18)`, borderRadius: 12, padding: "12px 14px", marginBottom: 14 }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(120px, 1fr))", gap: 8, marginBottom: 10 }}>
                  {totais.map(({ tp, total, qtd }) => (
                    <div key={tp} style={{ background: "var(--card2)", borderRadius: 8, padding: "8px 10px", border: "1px solid var(--border)" }}>
                      ...
                      <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 700, fontSize: 16, color: "var(--text)", lineHeight: 1, letterSpacing: "-0.03em" }}>{fmtMoeda(total)}</div>
                ...
                <div style={{ borderTop: "1px solid var(--border)", paddingTop: 8, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                  ...
                  <span style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 700, fontSize: 18, color: "var(--green)", letterSpacing: "-0.03em" }}>{fmtMoeda(grandTotal)}</span>
                </div>
              </div>
            );
          })()}
                ...
                return (
                  <div key={a.id || i} style={{ background: t.card, borderRadius: 11, border: `1px solid var(--border)`, borderLeft: `3px solid ${bordaC}`, padding: 12 }}>
                    <div style={{ display: "flex", alignItems: "flex-start", gap: 6, marginBottom: 6, flexWrap: "wrap" }}>
                      <span style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 700, fontSize: 13, letterSpacing: "-0.01em", color: "var(--yellow, #eab308)" }}>{a.numero || a.apontamento || "—"}</span>
