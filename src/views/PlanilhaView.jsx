...
export default function PlanilhaView({ ctx }) {
  ...
  const temFiltro = planilhaFiltroAno || planilhaFiltroMes || planilhaFiltroOrigem !== "todas" || planilhaFiltroDataDe || planilhaFiltroDataAte || planilhaBusca;
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "calc(100vh - 130px)" }}>
      ...
      <div className="co-filter-bar" style={{flexShrink:0}}>
        ...
        <span style={{ fontSize:9, color:"var(--text3)", fontFamily:"'DM Mono',monospace", letterSpacing:"0.08em", textTransform:"uppercase", marginLeft:4 }}>De:</span>
        ...
        {temFiltro && (
          <button onClick={() => { setPlanilhaFiltroAno(""); setPlanilhaFiltroMes(""); setPlanilhaFiltroOrigem("todas"); setPlanilhaFiltroDataDe(""); setPlanilhaFiltroDataAte(""); setPlanilhaBusca(""); setPlanilhaPagina(1); }}
            style={{
          ...
          <tbody>
            {dadosExibir.map((r, i) => (
              ...
              >
                ...
                <td style={{
                  padding: "7px 6px", borderBottom: "1px solid var(--border)",
                  fontFamily: "'DM Mono', monospace", fontSize: 11, letterSpacing: "0.06em", textAlign: "center",
                ...
                <td style={{
                  ...
                  fontSize: 10, textAlign: "center", fontFamily: "'DM Mono', monospace",
                  overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap",
                }}>
                  {r.data_desc || "—"}
                </td>
