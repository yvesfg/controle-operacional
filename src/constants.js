...
export const DEV_CHANGELOG = [
  {
    ...
    itens: [
      ...
      "PENDENTE (discussao) · Dashboard mostra 16 celulose (so DT'd, da tabela principal/DADOS) mas o total real e ~26 incluindo os sem-DT. DADOS alimenta Dashboard+Planilha+Financeiro -- injetar sem-DT ali afetaria tudo (risco). Opcao segura a decidir com Yves: indicador separado do sem-DT na visao de celulose, sem tocar no DADOS global.",
    ],
  },
  {
