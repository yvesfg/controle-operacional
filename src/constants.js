...
export const DEV_CHANGELOG = [
  {
    ...
    itens: [
      "FIX (Yves: 'Algo deu errado nesta tela' ao abrir a Conferencia) · O bloco do relatorio (relLinhas) tinha sido inserido ACIMA de linhasFiltradas: `const` nao sobe, entao a tela morria na montagem com 'Cannot access before initialization' e caia no ErrorBoundary. Bloco movido pra depois da declaracao. Nada de logica mudou.",
