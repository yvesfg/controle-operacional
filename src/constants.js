...
export const DEV_CHANGELOG = [
  {
    ...
    itens: [
      ...
      "BUG (achado pelo Yves) · O modal 'grupo de duplicidade' montava o grupo a partir de `pendentes`, entao o OUTRO CTe do par (ja revisado, de outro mes ou fora da fila) sumia: o modal abria com 1 item so e era impossivel saber com qual CTe era a duplicidade. Agora o grupo (e os candidatos a vinculo) saem de universoLinhas = mes exibido + os 2 meses do comparativo + fila + sinalizados, deduplicado por id.",
