...
export const DEV_CHANGELOG = [
  {
    ...
    itens: [
      ...
      "PENDENTE · Fase 4 (histórico de envio: 2ª vez sinaliza 'já enviado em…') não começou. O aviso de CNH vencida já aparece na ficha; falta o alerta de CNH vencendo antes do envio."
    ],
  },
  {
