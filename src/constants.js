...
export const DEV_CHANGELOG = [
  {
    ...
    itens: [
      ...
      "NUMEROS 07/2026 (para conferencia) · Imperatriz: 134 viagens, fat. R$ 1.233.910,67, pago R$ 974.864,18, margem R$ 259.046,49, despesa R$ 114.674,07, estorno R$ 1.854,80, receitas R$ 1.273,59, RESULTADO R$ 146.227,22. Belem: 21 viagens, fat. R$ 43.040,00, pago R$ 32.700,00, margem R$ 10.340,00, despesa R$ 16.672,24, RESULTADO -R$ 6.332,24 (dos quais R$ 9.131,96 sao a linha 'SALDO NEGATIVO MES 06/2026' -- sem ela Belem fecha positivo).",
