...
export const DEV_CHANGELOG = [
  {
    ...
    itens: [
      ...
      "PENDENTE · Fase 3 (templates por embarcadora + geração do .xlsx escolhendo as DTs) não começou. Fase 4 (histórico de envio e alerta de CNH vencendo) idem — o aviso de CNH vencida já aparece na ficha."
    ],
  },
  {
