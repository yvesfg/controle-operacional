...
// Ícones de linha (estilo do sidebar / hIco): viewBox 24, fill none, stroke currentColor.
// Uso: <Icon n="trash" s={16} c={t.danger} />  — substitui os emojis-badge dos modais.
import React from "react";

// Mapa conceito -> paths SVG (Feather/Lucide). Mantém o mesmo traço do sidebar.
const P = {
  // ações / estados
  ...
  stop:         <><polygon points="7.86 2 16.14 2 22 7.86 22 16.14 16.14 22 7.86 22 2 16.14 2 7.86 7.86 2"/></>,
  ...
  truck:        <><rect x="1" y="3" width="15" height="13" rx="2"/><path d="m16 8 4 2 3 3v4h-7"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></>,
  ...
  bank:         <><line x1="3" y1="22" x2="21" y2="22"/><line x1="4" y1="10" x2="4" y2="18"/><line x1="20" y1="10" x2="20" y2="18"/><line x1="9" y1="10" x2="9" y2="18"/><line x1="15" y1="10" x2="15" y2="18"/><polygon points="12 2 20 7 4 7"/></>,
  ...
  id:           <><rect x="2" y="4" width="20" height="16" rx="2"/><circle cx="8" cy="12" r="2.5"/><line x1="14" y1="10" x2="19" y2="10"/><line x1="14" y1="14" x2="19" y2="14"/></>,
  ...
  tool:         <><path d="M14.7 6.3a4 4 0 0 1 5 5L21 12l-3 3-9 9-3-3 9-9 3-3z"/><path d="M9.3 9.3a4 4 0 0 1-5-5"/></>,
  antenna:      <><circle cx="12" cy="12" r="2"/><path d="M16.24 7.76a6 6 0 0 1 0 8.49M7.76 16.25a6 6 0 0 1 0-8.49M19.07 4.93a10 10 0 0 1 0 14.14M4.93 19.07a10 10 0 0 1 0-14.14"/></>,
...
// Mapa de conveniência emoji -> nome, p/ referência durante a migração.
export const EMOJI_ICON = {
  "✕":"x","✗":"x","❌":"x-circle","✅":"check-circle","✓":"check","✔":"check",
  "⚠":"alert","🚨":"alert-octagon","🛑":"stop","🚫":"ban","→":"arrow-right",
  "🟢":"dot","🔴":"dot","🟡":"dot","⚫":"dot","☐":"square","⬜":"square",
  "📦":"package","🚛":"truck","📍":"map-pin","📅":"calendar","🏁":"flag","🛏":"bed",
  "📋":"clipboard","📄":"file-text","🧾":"receipt","📝":"edit","✏":"edit","💾":"save","🗑":"trash",
  "🔗":"link","📞":"phone","📧":"mail","💬":"message","📥":"upload","📤":"download","📲":"smartphone","✈":"plane",
