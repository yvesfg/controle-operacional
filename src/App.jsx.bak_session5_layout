                ...
                <div style={{position:"relative",marginBottom:2}}>
                  ...
                  {wppTipoOpen && (
                    <>
                      ...
                      <div style={{position:"fixed",left:220,top:"auto",background:t.card,border:`1px solid ${t.borda}`,borderRadius:12,overflow:"hidden",zIndex:500,minWidth:240,boxShadow:`0 8px 28px ${t.shadow}`,animation:"slideUp .2s"}}>
                        {buscaResult
