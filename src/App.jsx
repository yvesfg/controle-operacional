    ...
    <div style={css.app}>
      ...
      <div style={css.header}>
        ...
        <div style={{marginLeft:"auto",display:"flex",alignItems:"center",gap:7}}>
          ...
          {/* Relatório Geral */}
          <button onClick={()=>setRelGeralOpen(true)} title="Relatório Geral PDF" style={{...css.hBtn,color:t.ouro,border:`1.5px solid rgba(240,185,11,.3)`,padding:"8px 10px",fontSize:13}}>📊</button>
          {/* WhatsApp Dropdown */}
          <div style={{position:"relative"}}>
            <button onClick={()=>setWppTipoOpen(v=>!v)} title="WhatsApp" style={{...css.hBtn,color:"#25D366",border:`1.5px solid rgba(37,211,102,.3)`,padding:"8px 10px",fontSize:13}}>
              📲
            </button>
            {wppTipoOpen && (
              <>
                ...
                <div style={{position:"absolute",right:0,top:"110%",background:t.card,border:`1px solid ${t.borda}`,borderRadius:12,overflow:"hidden",zIndex:200,minWidth:230,boxShadow:`0 8px 28px ${t.shadow}`,animation:"slideUp .2s"}}>
                  ...
                  {[
                    ...
                    }} style={{width:"100%",background:"transparent",border:"none",borderBottom:i<arr.length-1?`1px solid ${t.borda}`:"none",padding:"10px 14px",color:t.txt,fontSize:12,fontWeight:600,cursor:"pointer",textAlign:"left",fontFamily:"inherit",display:"flex",alignItems:"flex-start",gap:10,transition:"background .15s"}}
      ...
      <div style={{padding:activeTab==="planilha"?"76px 0 68px":"76px 16px 68px",maxWidth:activeTab==="planilha"?"100%":1100,margin:"0 auto",animation:"fadeIn .2s"}}>
        ...
        {activeTab === "admin" && isAdmin && (
          <div>
            <div style={css.secTitle} className="sec-divider">🗄️ Banco de Dados</div>            <div style={{...css.card,marginBottom:16}}>
