      ...
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        @media(max-width:767px){
          ...
          .co-sidebar:not(.co-sidebar--mob-expanded) .co-sidebar__section-lbl{display:block!important;text-align:center;font-size:6px;white-space:normal;word-break:keep-all;padding:4px 1px 2px;line-height:1.2;letter-spacing:0.02em;overflow:visible}
