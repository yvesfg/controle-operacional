              ...
              return (<>
                ...
                <div style={{position:"relative",marginBottom:2}}>
                  <button
                    ...
                    onClick={()=>setWppTipoOpen(v=>!v)}
                    style={{border:`1px solid rgba(37,211,102,.18)`,borderRadius:DESIGN.r.sidebar,color:"#25D366",gap:10}}
                  >
                    <span className="co-sidebar__ico">
                      {hIco(<><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></>,"#25D366",16)}
                    </span>
                  ...
                  {wppTipoOpen && (
                    <>
                      ...
                      <div style={{position:"absolute",left:"100%",top:0,background:t.card,border:`1px solid ${t.borda}`,borderRadius:12,overflow:"hidden",zIndex:200,minWidth:230,boxShadow:`0 8px 28px ${t.shadow}`,animation:"slideUp .2s",marginLeft:4}}>
                        {buscaResult
