                          ...
                          <div key={nome} style={{marginBottom:10}}>
                            <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:4}}>
                              ...
                              <div style={{flex:1,minWidth:0}}>
                                ...
                                {placa&&<div style={{fontSize:8,color:t.txt2,fontFamily:"'DM Mono',monospace",letterSpacing:.5,marginTop:1}}>{placa}</div>}
                              </div>
                      ...
                      return (
                        ...
                        >
                          ...
                          <div style={{minWidth:0,flex:"0 0 110px"}}>
                            <div style={{fontSize:10,fontWeight:600,color:t.txt,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{nomeExib}</div>
                            <div style={{fontSize:8,color:t.txt2,fontFamily:"'DM Mono',monospace",letterSpacing:.4,marginTop:1,display:"flex",gap:5,overflow:"hidden"}}>
                          ...
                          <div style={{display:"flex",flexDirection:"column",alignItems:"flex-end",gap:2,flexShrink:0}}>
                            <span style={{padding:"1px 5px",borderRadius:4,fontFamily:"'DM Mono',monospace",fontSize:9,fontWeight:500,textTransform:"uppercase",color:sc(r.status),background:`${sc(r.status)}1a`,whiteSpace:"nowrap",letterSpacing:"0.04em"}}>{(r.status||"–").slice(0,10)}</span>
                            {canFin&&r.vl_cte&&parseFloat(r.vl_cte)>0&&<span style={{fontSize:9,fontWeight:600,color:t.txt,fontFamily:"'DM Mono',monospace"}}>{"R$"+(parseFloat(r.vl_cte)/1000).toFixed(1)+"k"}</span>}
                          </div>
                        </div>
                      );
                    })}
                          ...
                          return (
                            <div key={nome} style={{marginBottom:i<topPend.length-1?8:0}}>
                              <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:3}}>
                                ...
                                <span style={{fontSize:9,fontWeight:700,color:t.ouro,fontFamily:"'DM Mono',monospace",flexShrink:0}}>{fmtMoeda(sld)}</span>
                              </div>
                              <div style={{height:3,borderRadius:2,background:t.card2,overflow:"hidden"}}>
              ...
              <div style={{flexShrink:0,background:theme==="dark"?"linear-gradient(135deg,#161a1e,#1e2026)":`linear-gradient(135deg,#f8f9fa,#fff)`}}>
                <div style={{padding:"13px 16px 10px",display:"flex",alignItems:"center",gap:10,borderBottom:excluirConfirm==="detalhe"?`1px solid rgba(220,38,38,.25)`:`1px solid ${t.borda}`}}>
                  ...
                  <div style={{display:"flex",gap:6,flexShrink:0}}>
                    ...
                    <button onClick={()=>{setModalOpen(null);setExcluirConfirm(null);setExcluirTexto("");}} style={{background:"rgba(128,128,128,.1)",border:"none",borderRadius:7,width:44,height:44,cursor:"pointer",fontSize:16,color:t.txt2,display:"flex",alignItems:"center",justifyContent:"center"}}>✕</button>
                  </div>
                </div>
          ...
          <div style={{...css.overlay, alignItems:"center", backdropFilter:"blur(12px)", padding: isDesk?"24px":"12px"}}
            ...
            <div style={{...css.modal, borderRadius:20, maxWidth: isDesk?620:520, maxHeight:"calc(100vh - 48px)", animation:"fadeIn .2s ease"}}
              ...
              <div style={{padding:"14px 16px 10px", display:"flex", alignItems:"center", gap:10, borderBottom:`1px solid ${t.borda}`, flexShrink:0}}>
                ...
                <button onClick={()=>setPlanilhaDetalheReg(null)} style={{marginLeft:"auto",background:"rgba(128,128,128,.1)",border:"none",borderRadius:7,width:44,height:44,cursor:"pointer",fontSize:16,color:t.txt2,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}>✕</button>
              </div>
      ...
      {nfdAlertOpen && (
        <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,.82)",zIndex:10000,display:"flex",alignItems:"center",justifyContent:"center",padding:16}} onClick={()=>setNfdAlertOpen(false)}>
          <div style={{background:t.card,borderRadius:18,padding:20,width:"100%",maxWidth:420,border:`1.5px solid rgba(246,70,93,.35)`,boxShadow:"0 24px 64px rgba(0,0,0,.6)",maxHeight:"90vh",overflowY:"auto"}} onClick={e=>e.stopPropagation()}>
            ...
            {/* Ações */}
            <div style={{display:"flex",gap:8}}>
              <button onClick={()=>{setNfdAlertOpen(false);setNfdFotos([]);}} style={{flex:1,background:`rgba(128,128,128,.08)`,border:`1.5px solid ${t.borda}`,borderRadius:9,padding:"10px",color:t.txt2,fontWeight:700,fontSize:12,cursor:"pointer",fontFamily:"inherit"}}>
                Não houve NFD
              </button>
