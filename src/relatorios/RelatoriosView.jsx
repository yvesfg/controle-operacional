          ...
          <div style={{
            ...
            {[
              ...
              <div key={c.label} style={{
                ...
                <div style={{ fontSize: 10, fontFamily: "'DM Mono', monospace", letterSpacing: "0.06em", color: "var(--text3)", textTransform: "uppercase", marginBottom: 10 }}>
                  {c.label}
                </div>
                <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 700, fontSize: 36, color: c.color, letterSpacing: "-0.04em", lineHeight: 1, marginBottom: 8 }}>
                  {c.value}
                </div>
