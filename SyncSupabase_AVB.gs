...
function sincronizarAVB() {
  ...
  try {
    ...
    var enviados = enviarLotes(Object.keys(porChave).map(function(k) { return porChave[k].reg; }), statusGlobal, function(r) { return r.codigo || r.dt; });
...
function mapearColunaAVB(n) {
  var mapa = {
    ...
    // Datas adicionais AVB
    'data homerico': 'data_homerico', 'data homérico': 'data_homerico',
    'baixa homerico': 'baixa_homerico', 'baixa homérico': 'baixa_homerico',
    'ganchos': 'ganchos', 'gancho': 'ganchos',
    ...
    'cte comp': 'cte_comp',
    'cte comp vlr': 'vl_cte_comp', 'cte comp valor': 'vl_cte_comp',

    // Contato / Dados bancários (favorecido)
    'telefone': 'telefone',
    'nº app rodorrica': 'rodorrica', 'n app rodorrica': 'rodorrica', 'app rodorrica': 'rodorrica', 'rodorrica': 'rodorrica',
    'banco': 'banco',
